...
void ASubclass::debugPrint(ostream &os, int indent, char const *subtreeName) const
{
...
void ASubclass::xmlPrint(ostream &os, int indent) const
{
  XMLPRINT_HEADER(ASubclass);

  NodeList::xmlPrint(os, indent);

  XMLPRINT_GENERIC(x);
  XMLPRINT_FOOTER(ASubclass);
...
void AnotherSubclass::debugPrint(ostream &os, int indent, char const *subtreeName) const
{
...
void AnotherSubclass::xmlPrint(ostream &os, int indent) const
{
  XMLPRINT_HEADER(AnotherSubclass);

  NodeList::xmlPrint(os, indent);

  XMLPRINT_GENERIC(x);
  XMLPRINT_FOOTER(AnotherSubclass);
...
void Sub4::debugPrint(ostream &os, int indent, char const *subtreeName) const
{
...
void Sub4::xmlPrint(ostream &os, int indent) const
{
  XMLPRINT_HEADER(Sub4);

  Super::xmlPrint(os, indent);

  XMLPRINT_FOOTER(Sub4);
...
void ANewClass::debugPrint(ostream &os, int indent, char const *subtreeName) const
{
...
void ANewClass::xmlPrint(ostream &os, int indent) const
{
  XMLPRINT_HEADER(ANewClass);

  XMLPRINT_GENERIC(foo);
  XMLPRINT_FOOTER(ANewClass);
}
